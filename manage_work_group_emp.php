                    ...
                    <div class="page-content">
                        ...
                        <div class="page-bar">
                            <ul class="page-breadcrumb">
                                ...
                                <li>
                                    <span>จัดการกลุ่มพนักงาน  AUTODIAL</span>
                                </li>
                            </ul>
                        ...
                        <!-- END PAGE BAR -->
                        <!-- BEGIN PAGE TITLE-->
                        <h1 class="page-title"> จัดการกลุ่มพนักงาน AUTODIAL
                            <small></small>
                        </h1>
                        <!-- END PAGE TITLE-->
                        <!-- END PAGE HEADER-->
...
<![endif]-->
       ...
       <script src="https://cdn.datatables.net/1.10.19/js/jquery.dataTables.min.js" type="text/javascript"></script>
        ...
        <script src="js/arcollection_emp_group_auto.js" type="text/javascript"></script>
