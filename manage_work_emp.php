                    ...
                    <div class="page-content">
                        ...
                        <div class="page-bar">
                            <ul class="page-breadcrumb">
                                <li>
                                    <a href="#">Manage Data EMP AUTODIAL</a>
                                    <i class="fa fa-circle"></i>
                                </li>
                                <li>
                                    <span>จัดการพนักงาน  AUTODIAL</span>
                                </li>
                            </ul>
                        ...
                        <!-- END PAGE BAR -->
                        <!-- BEGIN PAGE TITLE-->
                        <h1 class="page-title"> จัดการพนักงาน AUTODIAL
                            <small></small>
                        </h1>
                        <!-- END PAGE TITLE-->
                        <!-- END PAGE HEADER-->
...
<!--                                            <button type="button" id="btnClear" data-loading-text="<i class='fa fa-spinner fa-spin '></i>" class="btn btn-lg btn-danger"><i class='fa fa fa-recycle'></i> ล้างข้อมูลทั้งหมด </button>-->
                                    ...
                                    <table class="display dataTable dtr-inline collapsed" id="WORKALL">
                                        <thead>
                                            <tr>
                                                <th> ID </th>
                                                <th> ARM_GROUP_NAME </th> 
                                                <th> ARM_GROP_CHILD </th>                                               
                                                <th> ARM_GRUOP_PARENT </th> 
                                                <th> CREATE_DATE </th>  
                                                <th> CREATE_BY </th>
                                                <th> UPDATE_DATE </th>
                                                <th> UPDATE_BY </th>
...
<![endif]-->
       ...
       <script src="https://cdn.datatables.net/1.10.19/js/jquery.dataTables.min.js" type="text/javascript"></script>
        ...
        <script src="js/arcollection_emp_auto.js" type="text/javascript"></script>
