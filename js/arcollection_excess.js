...
$(function () {
    ...
    $.ajax({
        url:'worklist/' + $("#txtEmpID").val() + 'EXCESS.json',
            type:'HEAD',
            error: function()
            {            
            ...
            success: function()
            {  
                LoadDatatable('worklist/'+$("#txtEmpID").val() + 'EXCESS.json');
            }
    });
...
function LoadDataJson(){
    ...
    $.ajax('get_arcollection.php', {       
       ...
       table.destroy();  
       var file = 'worklist/' + $("#txtEmpID").val() + 'EXCESS.json';
       LoadDatatable(file);   
...
var table = $('#WORKLISTOD').DataTable();
    ...
    $('#WORKLISTOD tbody').on('click', 'tr', function () {
            ...
            var tbRow = table.row(this).data();
            //console.log(tbRow.ARM_ACC_NO);
            window.open("arcollection_detial.php?pageslug=EXCESS&accno=" + btoa(tbRow.ARM_ACC_NO),'_blank');
            //window.location.assign("arcollection_detial.php?accno=" + btoa(tbRow.ARM_ACC_NO));        
        });
