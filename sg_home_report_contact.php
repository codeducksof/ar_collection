...
$pageSlug = 'SG-HOME-REPORT-CONTACT';
?>
<!DOCTYPE html>
<!-- 
...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>AR COLLECTION | รายงานผลการติดต่อจาก SG HOME</title>
                    ...
                    <div class="page-content">
                        ...
                        <div class="page-bar">
                            <ul class="page-breadcrumb">
                                ...
                                <li>
                                    <span>
                                        รายงานการติดต่อจากลูกค้า SG-HOME
                                    </span>
                                </li>
                            </ul>
                        ...
                        <!-- END PAGE BAR -->
                        <!-- BEGIN PAGE TITLE-->
                        <h1 class="page-title"> รายงานการติดต่อจากลูกค้า SG-HOME 
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="portlet-body">
                                    ...
                                    <table class="display dataTable dtr-inline collapsed" id="SGHOMEREPORT">
                                        <thead>
                                            <tr>
                                                <th> ARM_ACC_NO </th>
...
<![endif]-->
        ...
        <script src="js/arcollection_report_sghome.js" type="text/javascript"></script>
    </body>
