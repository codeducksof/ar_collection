                        ...
                        <div class="page-content-wrapper">
                            ...
                            <div class="page-content">
                                ...
                                <h1 class="page-title"> รายการบัญชีเลขที่ 
                                    <small><span id="lbAccno"></span><?php //echo $accno; ?> | <span id="lbCusName"></span><input type='hidden' id='txtGetAccNo' name='txtGetAccNo' value='<?php echo $accno; ?>'></small>
                                </h1>
<!--                                <div class="row" style="display:none;">-->
<!--                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">-->
<!--                                        <a class="btn btn-primary" data-toggle="collapse" href="#callphone" role="button" aria-expanded="false" aria-controls="collapseExample"><i class="fa fa-phone"> </i> CALL PHONE  </a>-->
<!--                                        <div class="collapse" id="callphone">-->
<!--                                            <div class="card card-body">-->
<!--                                               <iframe src="https://qm-a01.protollcall.com/demoautooutbound/cti/" width="100%" height="400"></iframe>-->
<!--                                            </div>-->
<!--                                        </div>-->
<!---->
<!--                                    </div>-->
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <div class="portlet-body">
                                            <div class="tabbable-line">
                                                ...
                                                <div class="text-center" id="dtLoading"><i class="fa fa-circle-o-notch fa-spin fa-4x fa-fw"></i></div>
                                                ...
                                                <ul class="nav nav-tabs">
                                                    ...
                                                    <li><a data-toggle="tab" id="btnAccHistory" href="#AccHistory">ประวัติการถือบัญชี</a></li>
                                                </ul>
                                                            ...
                                                            <div class="portlet grey-mint box">
                                                                ...
                                                                <div class="portlet-body">
                                                                    ...
                                                                    <div class="row">
                                                                                    ...
                                                                                    <table class="table table-bordered table-hover">
                                                                                        <thead>
                                                                                            <tr>
                                                                                                ...
                                                                                                <th class="bg-warning"> รหัสสินค้า </th>
                                                                                                <th class="bg-warning"> รายละเอียดสินค้า </th>
                                                                                                <th class="bg-warning"> รายละเอียดสินค้ารุ่นสินค้า </th>
                                                                                                <th class="bg-warning"> ซีเรียล </th>
                                                                                                <th class="bg-warning"> สี </th>
                                                                                            </tr>
                                                                                        </thead>
                                                                                        <tbody id="lbProduct">
																		...
																		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                            <div class="form-group">                                                   
                                                                                <label>ตารางภาระหนี้ :</label>
                                                                                <div class="table-scrollable">
                                                                                    <table class="table table-bordered table-hover">
                                                                                        <thead>
                                                                                            <tr>
                                                                                                <th class="bg-info"> งวดที่ </th>
                                                                                                <th class="bg-info"> วันที่ชำระเงินกู้ (ว/ด/ป) </th>
																								<th class="bg-info"> รวม </th>
                                                                                                <th class="bg-info"> เงินต้น </th>
                                                                                                <th class="bg-info"> ดอกเบี้ยเงินกู้ </th>                                                                                               
                                                                                                <th class="bg-info"> เงินต้นคงค้าง </th>																								
                                                                                            </tr>
                                                                                        </thead>
                                                                                        <tbody id="lbDebtStep">
                                                                        ...
                                                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="lbHistoryHeadRefinance" style="display:none;">
                                                                            <div class="form-group">                                                   
                                                                                <label>ประวัติ Refinance หรือ ปรับปรุงโครงสร้าง :</label>
                                                                                <div class="table-scrollable" >
                                                                                    <table class="table table-bordered table-hover">
                                                                                        <thead>
                                                                                            <tr>
                                                                                                <th class="bg-success">#</th>
                                                                                                <th class="bg-success">วันที่ปรับปรุง</th>
                                                                                                <th class="bg-success">วันที่ชำรำครั้งแรก</th>
                                                                                                <th class="bg-success">ค่างวด</th>
                                                                                                <th class="bg-success">ระยเวลา</th>
                                                                                                <th class="bg-success">ยอดเงินสด</th>
                                                                                                <th class="bg-success">ยอดเช่าซื้อ</th>
                                                                                                <th class="bg-success">ยอดคงเหลือ</th>
                                                                                                <th class="bg-success">ยอดที่ชำระมาทั้งหมด</th>                                                                                               
                                                                                            </tr>
                                                                                        </thead>
                                                                                        <tbody id="lbHistoryRefinanceList">
                                                                        ...
                                                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="lbHpStep" style="display:none;">
                                                                            <div class="form-group">                                                   
                                                                                <label>การผ่อนชำระแบบบอลลูน :</label>
                                                                                <div class="table-scrollable">
                                                                                    <table class="table table-bordered table-hover">
                                                                                        <thead>
                                                                                            <tr>
                                                                                                <th class="bg-info">#</th>
                                                                                                <th class="bg-info">งวดเริ่มต้น</th>
                                                                                                <th class="bg-info">งวดสิ้นสุด</th>
                                                                                                <th class="bg-info">ยอดที่ต้องผ่อนชำระ</th>                                                                                                                                                                                            
                                                                                            </tr>
                                                                                        </thead>
                                                                                        <tbody id="lbHpStepList">
																		...
																		<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                            <div class="form-group">                                                   
                                                                                <label>รหัสอนุมัติ  :</label> <label id="APPROVE_CODE">  </label>
                                                                            </div>
                                                                        </div>
																		<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                            <div class="form-group">                                                   
                                                                                <label>เหตุผลในการอนุมัติ  :</label> <label id="ARRPROVE_REASON">  </label>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                            <div class="form-group">                                                   
                                                                        ...
                                                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                            <div class="form-group">                                                   
                                                                                <label>เลขที่บัญชี :</label> <label id="ARM_ACC_NO_DISPLAY">  </label><label id="ARM_ACC_NO" style="display: none;">  </label>
...
<!--                                                                                            <th></th>-->
                                                                                            ...
                                                                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                                                ...
                                                                                                <div class="form-group"> 
                                                                                                    ...
                                                                                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                                                        ...
                                                                                                        <input type="number" id="reWaiveAmt" name="reWaiveAmt" class="form-control" readonly="readonly">                                                                                                        
                                                                                                    </div>
                                                                                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                                                        <label> ยอดเงินที่สามารถขอได้ <font style="color:red;">*</font></label>
                                                                        ...
                                                                        <form data-toggle="validator" role="form" id="frmAddrecordCall">
                                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                                <div class="form-group">                                                   
                                                                                    ...
                                                                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                                        <input type="tel" id="txtCustTel" maxlength="10" name="txtCustTel" pattern="^\d{9}|\d{10}$" class="form-control"  required="required" autofocus/>
                                                                                    </div>   
                                                                                </div>                                                   
                                                                            </div>
                                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                                <div class="form-group">                                                   
                                                                                    ...
                                                                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                                        <select class="selectpicker form-control" data-show-subtext="true" data-live-search="true" id="txtTrackCode" required="required" autofocus>
                                                                            ...
                                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                                <div class="form-group">                                                   
                                                                                    ...
                                                                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                                        <select class="selectpicker form-control" data-show-subtext="true" data-live-search="true" id="txtWorkPlan" required="required" autofocus>
                                                                                            <option value="" data-subtext=""> --- เลือก --- </option>
                                                                                    ...
                                                                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                                        <div class="form-group">
                                                                                            <div class='input-group date' id='cContactDate'>
                                                                                                <input type='text' class="form-control" id="txtContactDate" name='txtContactDate' disabled="disabled" required="required" autofocus/>
                                                                                    ...
                                                                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                                        <div class="form-group">
                                                                                            <div class='input-group date' id='cPlanDate'>
                                                                                                <input type='text' class="form-control" id="txtPlanDate" name='txtPlanDate' required="required" autofocus/>
                                                                                                <span class="input-group-addon">
                                                                            ...
                                                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                                <div class="form-group"> 
                                                                                    ...
                                                                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                                        <textarea id="txtRecordDesc" name="txtRecordDesc" rows="5" class="form-control" required="required" autofocus></textarea>
                                                                                    </div>   
                                                                            ...
                                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                                <div class="form-group"> 
                                                                                    ...
                                                                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                                        <input type="text" id="txtLat" name="txtLat" class="form-control" readonly="readonly" required="required" autofocus>
                                                                                    </div>
                                                                                </div>
                                                                            </div> 
                                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                                <div class="form-group"> 
                                                                                    ...
                                                                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                                        <input type="text" id="txtLong" name="txtLong" class="form-control" readonly="readonly" required="required" autofocus>
                                                                                    </div> 
                                                                            ...
                                                                            <div id="bltcReqClaim" style="display:none;">
                                                                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                                    <div class="form-group"> 
                                                                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                                            <label for="txtInstallment">LATE : <font color="red">*</font></label>  
                                                                                        </div>
                                                                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                                            <input type="text" id="txttcReqLate" name="txttcReqLate" class="form-control">
                                                                                            <input type="hidden" id="hdtcReqLate" name="hdtcReqLate" class="form-control">
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                                    <div class="form-group"> 
                                                                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                                            <label for="txtInstallment">CLAIM : <font color="red">*</font></label>  
                                                                                        </div>
                                                                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                                            <input type="text" id="txttcReqClaim" name="txttcReqClaim" class="form-control">
                                                                                            <input type="hidden" id="hdtcReqClaim" name="hdtcReqClaim" class="form-control">
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                                    <div class="form-group"> 
                                                                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                                            <label for="txtInstallment">INSTALLMANET : <font color="red">*</font></label>  
                                                                                        </div>
                                                                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                                            <input type="text" id="txttcReqInstallment" name="txttcReqInstallment" class="form-control">
                                                                                            <input type="hidden" id="hdtcReqalance" name="hdtcReqalance" class="form-control">
                                                                                        </div>
                                                                                    </div>
                                                                                </div> 
                                                                            </div>
                                                                            <div id="blreturn" style="display:none;">
                                                                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                                    <div class="form-group"> 
                                                                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                                            <label for="txtRecievereturn">ผู้รับสินค้า :<font color="red">*</font> </label>  
                                                                                        </div>
                                                                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                                ...
                                                                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                                    <div class="form-group"> 
                                                                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                                            <label for="cDateReturn">วันที่ยึดคืน : <font color="red">*</font></label>  
                                                                                        </div>
                                                                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                                            <div class="form-group">
                                                                            ...
                                                                            <div id="blsignal" style="display:none;">
                                                                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                                    <div class="form-group">                                                   
                                                                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                                            <label for="cCloseSignalDate">วัน/เวลา ปิดสัญญาณ : </label>  
                                                                                        </div>
                                                                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                                            <div class="form-group">
                                                                                ...
                                                                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                                    <div class="form-group">                                                   
                                                                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                                            <label for="cOpenSignalDate">วัน/เวลา เปิดสัญญาณ : </label>  
                                                                                        </div>
                                                                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                                            <div class="form-group">
                                                                            ...
                                                                            <div id="blpayment" style="display:none;">    
                                                                                ...
                                                                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                                    <div class="form-group">                                                   
                                                                                        ...
                                                                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                                            <input type="text" id="txtAppointmentAmt" name="txtAppointmentAmt" class="form-control"/>
                                                                                        </div>   
                                                                                    </div>                                                   
                                                                                </div>
                                                                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                            ...
                                                                            <div class="col-lg-12 col-md-12 col-sm-6 col-xs-12">
                                                                                ...
                                                                                <div id="err2" class="alert alert-danger" style="display:none;">
                                                                                    <strong>ERROR !</strong> ยอดที่ขอเกินกว่าความเป็นจริง !
                                                                                </div>
        ...
        <?php } ?>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                        ...
                                                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                                ...
                                                                                <div class="modal-dialog modal-lg">
                                                                                    ...
                                                                                    <div class="modal-content">
                                                                                        ...
                                                                                        <div class="modal-body">
                                                                                            <div class="row">
                                                                                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                                                    <table class="table-bordered dataTable dtr-inline collapsed">
                                                                                                        <tbody>
                                                                                                            <tr>
                                                                                                                <td><label>เบอร์โทรติดต่อ : </label></td>
                                                                                                                <td><label class="text-success" id="ARM_CUSTOMER_TEL">  </label></td>
                                                                                                                <td><label>ผลการติดตาม : </label></td>
                                                                                                                <td><label class="text-danger" id="ARM_TRACK_CODE">  </label></td>
                                                                                                            </tr>
                                                                                                            <tr>
                                                                                                                <td><label>แผนงาน : </label></td>
                                                                                                                <td> <label class="text-danger" id="ARM_WORKPLAN_ID">  </label></td>
                                                                                                                <td><label>วัน/เวลา ที่ติดตาม : </label></td>
                                                                                                                <td><label class="text-warning" id="ARM_CALL_DATE">  </label></td>
                                                                                                            </tr>
                                                                                                            <tr>
                                                                                                                <td><label>วัน/เวลา แผนงาน : </label></td> 
                                                                                                                <td><label class="text-warning" id="ARM_WORKPLAN_TIME">  </label></td> 
                                                                                                                <td><label>ผู้ดำเนินการ : </label></td> 
                                                                                                                <td><label id="ARM_OPERATOR_ID">  </label></td>
                                                                                                            </tr>
                                                                                                            <tr>
                                                                                                                <td><label>รายละเอียดการติดตาม : </label></td> 
                                                                                                                <td><label id="ARM_RECORD_CALL_DETAIL">  </label></td>
                                                                                                                <td><label>ละติจูด : </label></td>
                                                                                                                <td><label id="ARM_LATITUDE">  </label></td> 
                                                                                                            </tr>
                                                                                                            <tr>
                                                                                                                <td><label>ลองจิจูด : </label></td>
                                                                                                                <td><label id="ARM_LONGITUDE">  </label></td>
                                                                                                                <td><label>วัน/เวลา นัดชำระ : </label></td>
                                                                                                                <td><label class="text-warning" id="ARM_PAYMENT_DATE">  </label></td>
                                                                                                            </tr>
                                                                                                            <tr>
                                                                                                                <td><label>จำนวนเงินที่นัดชำระ : </label></td>
                                                                                                                <td><label id="ARM_PAYMENT_AMT">  </label></td>
                                                                                                                <td><label>วันที่เก็บเงิน : </label></td>
                                                                                                                <td><label id="ARM_DATE_COLLECT">  </label></td>
                                                                                                            </tr>
                                                                                                            <tr>
                                                                                                                <td><label>จำนวนเงินที่ให้ส่วนลด : </label></td>
                                                                                                                <td><label id="ARM_MONEY_DISCOUNT">  </label></td>
                                                                                                                <td><label>จำนวนเงินที่ชำระ : </label></td>
                                                                                                                <td><label id="ARM_PAYMENT_AMT2">  </label></td>
                                                                                                            </tr>
                                                                                                            <tr>
                                                                                                                <td><label>วัน/เวลา ปิดสัญญาณ : </label></td>
                                                                                                                <td><label class="text-success" id="ARM_SIGNAL_CLOSE_DATE">  </label></td>
                                                                                                                <td><label>วัน/เวลา เปิดสัญญาณ : </label></td>
                                                                                                                <td><label class="text-success" id="ARM_SIGNAL_OPEN_DATE">  </label></td>
                                                                                                            </tr>
                                                                                                            <tr>
                                                                                                                <td><label>ค่าต่อสัญญาณ : </label></td>
                                                                                                                <td><label id="ARM_SIGNAL_OPEN_AMT">  </label></td>
                                                                                                                <td><label>ค่าธรรมเนียม : </label></td>
                                                                                                                <td><label id="ARM_FEE_AMT">  </label></td>
                                                                                                            </tr>
                                                                                                            <tr>
                                                                                                                <td><label>ราคาเช่าซื้อรีไฟแนนซ์ : </label></td>
                                                                                                                <td><label id="ARM_REFINANCE_AMT">  </label></td>
                                                                                                                <td><label>จำนวนเงินที่เก็บครั้งแรก : </label></td>
                                                                                                                <td><label id="ARM_FIRST_COLLECT">  </label></td>
                                                                                                            </tr>
                                                                                                            <tr>
                                                                                                                <td><label>ค่างวด : </label></td>
                                                                                                                <td><label id="ARM_INSTALLMENT_AMT">  </label></td>
                                                                                                                <td><label>จำนวนงวด : </label></td>
                                                                                                                <td><label id="ARM_INSTALLMENT_COUNT">  </label></td>
                                                                                                            </tr>
                                                                                                            <tr>
                                                                                                                <td><label>จำนวนเงินที่ทุจริต : </label></td>
                                                                                                                <td><label id="ARM_CORRUPT_AMT">  </label></td>
                                                                                                                <td><label>ชื่อผู้ทุจริต : </label></td>
                                                                                                                <td><label id="ARM_CORRUPT_NAME">  </label></td>
                                                                                                            </tr>
                                                                                                            <tr>
                                                                                                                <td><label>ตำแหน่งผู้ทุจริต : </label></td>
                                                                                                                <td><label id="ARM_CORRUPT_POSITION">  </label></td>
                                                                                                                <td><label>ผู้รับคืนสินค้า : </label></td>
                                                                                                                <td><label id="ARM_RECIEVER_PRODUCT">  </label></td>
                                                                                                            </tr>
                                                                                                            <tr>
                                                                                                                <td><label>วันที่ยึดคืน : </label></td>
                                                                                                                <td><label id="ARM_IMPOUND_DATE">  </label></td>
                                                                                                                <td><label>คืนสินค้าที่สาขา : </label></td>
                                                                                                                <td><label id="ARM_SHOP_NAME">  </label></td>
                                                                                                            </tr>
                                                                                                            <tr>
                                                                                                                <td><label>ตำแหน่งผู้รับคืนสินค้า : </label></td>
                                                                                                                <td><label id="ARM_RECIEVER_POSITION">  </label></td> 
                                                                                                                <td><label>INSTALLMENT : </label></td>
                                                                                                                <td><label id="tcReqInstallmentV"> </label></td> 
                                                                                                            </tr>
                                                                                                            <tr>
                                                                                                                <td><label>CLAIM : </label></td>
                                                                                                                <td><label id="tcReqClaimV">  </label></td> 
                                                                                                                <td><label>LATE : </label></td>
                                                                                                                <td><label id="tcReqLateV">  </label></td> 
                                                                                                            </tr>
                                                                                                        </tbody>                                                                                                    
                                                                                                    </table>
                                                                                                </div>
                                                                            ...
                                                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                                <div class="row">
                                                                                    <button type="button" id="btnLoadHistoryRecord" class="btn btn-default btn-danger btn-lg center-block">แสดงประวัติย้อนหลัง</button>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                        ...
                                                        <div class="portlet red-mint box" id="tbRecordHis" style="display:none;">
                                                            <div class="portlet-title">
                                                                <div class="form-group">                                                   
                                                                    <h4><i class="fa fa-reply"></i> ประวัติการติดตามย้อนหลัง</h4>
                                                                </div>
                                                            </div>
                                                            <div class="portlet-body">
                                                                <div class="row">
                                                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                        ...
                                                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                            <div class="portlet-body">
                                                                                ...
                                                                                <table class="display dataTable dtr-inline collapsed" id="RECORDHIS">
                                                                                    <thead>
                                                                                        <tr>
                                                                                            <th> วันที่ติดต่อ </th>
                                                                                            <th> เบอร์ที่ติดต่อ </th> 
        ...
        <?php } ?>
                                                    ...
                                                    <div id="AccHistory" class="tab-pane fade in">
                                                        <input type="hidden" id="tabAccHistory" name="tabAccHistory" value="0">
                                                        <div class="table-toolbar">
                                                            <div class="text-center" id="dtLoading4" style="display:none;"><i class='fa fa-spinner fa-spin fa-4x'></i></div>
                                                        </div>
                                                        ...
                                                        <div class="portlet red-thunderbird box">
                                                            <div class="portlet-title">
                                                                <div class="form-group">                                                   
                                                                    <h4><i class="fa fa-sticky-note-o"></i> ประวัติการถือบัญชี</h4>
                                                                </div>
                                                            </div>
                                                            <div class="portlet-body">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                        <div class="portlet-body">
                                                                            <div class="table-toolbar">
                                                                                <button type="button" id="btnRefreshAccHistory" data-loading-text="<i class='fa fa-spinner fa-spin '></i>" class="btn btn-lg btn-success red-thunderbird center-block"><i class='fa fa fa-refresh'></i> </button>
                                                                            </div>
                                                                            <table class="display dataTable dtr-inline collapsed" id="ACCHISTORY">
                                                                                <thead>
                                                                                    <tr>
                                                                                        <th> User_ID_TO </th> 
                                                                                        <th> User_NAME </th> 
                                ...
                                <div id="BLOCK" class="modal fade" role="dialog">                                    
                                            <div class="modal-dialog modal-sm">
                                                ...
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                                                        <h4 class="modal-title"><i class="fa fa-warning"></i><strong> คำเตือน</strong></h4>
                                                    </div>
                                                    <div class="modal-body">
                                                        <div class="row">
                                                                ...
                                                                <div class="form-group">
                                                                    <div class="col-lg-12 col-md-12 col-sm-6 col-xs-12">
                                                                        ...
                                                                        <div class="alert alert-warning">
                                                                            <h4> <p> <i class="fa fa-warning"></i> วันนี้ได้ทำการติดตามลูกค้ารายนี้แล้ว ขอให้ติดต่อใหม่ในวันถัดไป</p></h4>
                                                                        </div>
...
<!--                <script src="plugins/pdfmake.min.js" type="text/javascript"></script>-->
                ...
                <script src="js/arcollection_detail.js" type="text/javascript"></script>
            </body>
        <?php
    }
}
