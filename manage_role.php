            ...
            <div class="page-container">
                ...
                <div class="page-content-wrapper">
                    ...
                    <div class="page-content">
                        ...
                        <!-- END PAGE BAR -->
                        <!-- BEGIN PAGE TITLE-->
                        <h1 class="page-title"> จัดการ Role
                            <small></small>
                        </h1>
                        <!-- END PAGE TITLE-->
                        <!-- END PAGE HEADER-->
                                ...
                                <div class="portlet-body">
                                    ...
                                    <div class="table-toolbar">
                                        <div class="form-group">
                                           <button type="button" id="btnAddRole" data-loading-text="<i class='fa fa-spinner fa-spin '></i>" class="btn btn-lg btn-success center-block"><i class='fa fa fa-plus'></i> เพิ่ม ROLE </button>
                                        </div>
                                    </div>
                                    <table class="display dataTable dtr-inline collapsed" id="ROLE">
...
<!--                                                <th> พนักงาน </th>-->
                                   ...
                                   <div id="ROLEDETAIL" class="modal fade" role="dialog">                                    
                                    <div class="modal-dialog modal-lg">
                                        <!-- Modal content-->
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <button type="button" class="close" data-dismiss="modal">&times;</button>
                                                <h4 class="modal-title"> เพิ่ม ROLE</h4>
                                            </div>
                                                    ...
                                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                        ...
                                                        <div class="form-group"> 
                                                            ...
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                                                ...
                                                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                    <label for="textEmpName">ชื่อ ROLE : <font color="red"> * </font> </label>  
                                                                </div>
                                                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">                                                                  
                                                            ...
                                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                <div class="form-group"> 
                                                                    <button type="button" id="btnSaveRole" data-loading-text="<i class='fa fa-spinner fa-spin '></i>" class="btn btn-lg btn-success center-block"><i class='fa fa fa-save'></i> บันทึกรายการ </button>
                                                                </div>
                                                            </div>  
                                                        </div>
                                ...
                                <div id="ROLEDETAILEDIT" class="modal fade" role="dialog">                                    
                                    <div class="modal-dialog modal-lg">
                                        <!-- Modal content-->
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <button type="button" class="close" data-dismiss="modal">&times;</button>
                                                <h4 class="modal-title"> แก้ไข ROLE</h4>
                                            </div>
                                            <div class="modal-body">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                        ...
                                                        <div class="form-group">
                                                            <div class="col-lg-12 col-md-12 col-sm-6 col-xs-12">
                                                                ...
                                                                <div id="rolee_succ" class="alert alert-success" style="display:none;">
                                                                    <strong>สำเร็จ !</strong> บันทึกข้อมูลเรียบร้อย.!
                                                                </div>
                                                                <div id="rolee_err" class="alert alert-danger" style="display:none;">
                                                                    <strong>ERROR !</strong> กรุณาป้อนข้อมูลให้ครบทุกช่องที่มี * !
                                                                </div>
                                                        ...
                                                        <div class="form-group"> 
                                                            ...
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                                                ...
                                                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">  
                                                                    <input type="hidden" class="form-control" id="txtRoleIDEdit" name="txtRoleID">
                                                                    <input type="text" class="form-control" id="txtRoleNameEdit" name="txtRoleNameEdit">
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                <div class="form-group"> 
                                                                    <button type="button" id="btnUpdateRole" data-loading-text="<i class='fa fa-spinner fa-spin '></i>" class="btn btn-lg btn-success center-block"><i class='fa fa fa-save'></i> บันทึกรายการ </button>
                                                                </div>
                                                            </div>  
                                                        </div>
                                ...
                                <div id="ROLEEMP" class="modal fade" role="dialog">                                    
                                    <div class="modal-dialog modal-lg">
                                        <!-- Modal content-->
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <button type="button" class="close" data-dismiss="modal">&times;</button>
                                                <h4 class="modal-title"> ROLE <span id="pRoleName"> </span></h4>
                                            </div>
                                            <div class="modal-body">
                                                <div class="row">
                                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                    ...
                                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                        ...
                                                        <div class="form-group"> 
                                                            ...
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                                                ...
                                                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                    <input type="hidden" class="form-control" id="txtRoleID" name="txtRoleID">
...
<![endif]-->
        ...
        <script src="js/manage_role.js" type="text/javascript"></script>
